...
Write the plan into an docs/features/XXX_PLAN.md file with the name of the feature replacing the XXX. Create the folder automatically if not there. If there is a name conflict then add a number to the feature name.